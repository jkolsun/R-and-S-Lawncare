...
export const metadata: Metadata = {
  ...
  description:
    "Real reviews from R&S Lawn Care clients across Spokane, Spokane Valley, Liberty Lake, Airway Heights, Medical Lake, and Cheney.",
};
...
const reviews = [
  {
    ...
    location: "Spokane, WA",
    rating: 5,
    text: "R&S Lawn Care has been maintaining our property for over two years and we couldn't be happier. They show up on schedule, do thorough work, and our lawn has never looked better. Highly recommend them to anyone in the Spokane area.",
  },
  {
    name: "David & Karen T.",
  ...
  },
  {
    ...
    rating: 5,
    text: "Incredible attention to detail. The crew always edges perfectly, trims around every obstacle, and leaves our property spotless. The fertilizer program has been a game-changer for keeping our lawn healthy year-round.",
  },
  {
    name: "Jennifer L.",
  ...
  },
  {
    ...
    location: "Cheney, WA",
    rating: 5,
    text: "I manage several rental properties and R&S takes care of all of them. They are dependable, reasonably priced, and keep every property looking great. My tenants always comment on how well-maintained the grounds are.",
  },
  {
    name: "Rachel G.",
    location: "Liberty Lake, WA",
    rating: 5,
    text: "The fall cleanup service alone is worth every penny. Our yard was buried in leaves and the R&S crew had it looking immaculate in a few hours. They also did a fantastic job preparing our lawn for winter. Five stars across the board.",
  },
  {
    name: "Steve & Ann B.",
    location: "Spokane, WA",
    rating: 5,
    text: "We hired R&S for shrub trimming and were so impressed that we signed up for full lawn care service. Their work is meticulous and Russell is great to deal with. The best lawn care company we have ever worked with.",
  },
  {
    name: "Patricia H.",
    location: "Spokane Valley, WA",
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-primary-dark py-14 md:py-24 lg:py-32">
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 max-w-3xl mx-auto">
            ...
            the Spokane area who trust R&S Lawn Care with their properties.
          </p>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subtitle="Get a free quote today and see why Spokane-area homeowners trust R&S Lawn Care."
      />
    </>
  );
}
